import { PGPCardCollection, PGPImageCardItem } from '../../../../types/components'
import { PGPCard } from './PGPCard'

/**
 * A component that renders a collection of cards in a grid layout.
 * @param {PGPCardCollection} props - Component props
 ...
 */
const PGPCardCollectionBody = ({cards, count, id, editKey}: PGPCardCollection): React.ReactElement => {
    ...
    return (
        ...
        >
            {cards?.map((cardData: PGPImageCardItem, idx: number) => {
