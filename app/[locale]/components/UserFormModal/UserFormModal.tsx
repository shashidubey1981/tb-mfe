...
const UserFormModal: React.FC<UserFormModalProps> = (props: UserFormModalProps) => {
    ...
    const { fields, user_consent_text, submit } = form || {}
            ...
            >
                ...
                {cookies_consent && ((document.cookie.indexOf('cookie_consent=optIn') === -1) && (cookies_consent.heading || cookies_consent.message)) ? (
                    <div className='flex flex-col items-center justify-center h-full text-center py-10'>
                        ...
                        {cookies_consent?.heading && <h3 className='text-white text-3xl font-bold mt-4 animate-fade-in-up before:hidden'>
                            {cookies_consent.heading}
                        </h3>}
                        {cookies_consent?.message && <p className='text-white mt-2 animate-fade-in-up'>
                            {cookies_consent.message}
                        </p>}
                    </div>
                ) : submissionSuccess ? (
                    <div className='flex flex-col items-center justify-center h-full text-center py-10'>
                        <h3 className='text-white text-2xl font-bold mt-4 animate-fade-in-up before:hidden'>
                    ...
                    <>
                        ...
                        {heading && (
                            <h2 className='text-white text-3xl lg:text-4xl my-4 lg:my-0 mb-[15px] lg:mb-[30.0px] before:hidden' data-id='h2-text'>
                                {heading}
                            </h2>
                        )}
                        <form className='mb-[15px] md:mb-[30.3px]' onSubmit={handleSubmit} lang='fr'>
                            ...
                            {user_consent_text && (
                                <div className='mb-[15px] flex items-start space-x-1 md:mb-[35.63px] md:space-x-2'>
                                    <input
                                        type='checkbox'
